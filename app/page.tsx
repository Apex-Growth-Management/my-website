    ...
    <main className="bg-white text-gray-900">
      ...
      <footer className="bg-gray-900 py-10 px-6 text-center text-sm">
        ...
        <div className="flex justify-center mt-5 mb-1">
          <a href="https://www.instagram.com/jack.franciss70/" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white transition-colors" aria-label="Instagram">
